...
/**
 * `주문하기`를 누른 뒤 기다리던 수량 저장이 끝나기까지 버튼 옆에 뜨는 말.
 * 주문서는 서버 수량을 읽으므로 저장이 끝난 뒤에 가야 한다(#179) — 그동안 버튼이
 * 잠기는데 이유를 안 적으면 사장이 되풀이해 누른다.
 */
export const LEAVING_TO_CHECKOUT = "수량을 저장하고 주문서로 가요.";
